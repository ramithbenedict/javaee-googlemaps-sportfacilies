...
public class ActiviteController implements Serializable {
    ...
    @EJB
    private model.ActiviteFacade ejbFacade;
    ...
    public Activite getActivite(java.lang.Integer id) {
    ...
    public static class ActiviteControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Activite) {
                ...
                return getStringKey(o.getNumActivite());
            } else {
    ...
    public List<String> completeActivity(String query) {
        List<String> results = new ArrayList<>();
        for(Activite a : getItems()){
            if(a.getNomActivite().toUpperCase().contains(query.toUpperCase()) || a.getNomActivite().toLowerCase().contains(query.toLowerCase()))
                results.add(a.getNomActivite());
        }
